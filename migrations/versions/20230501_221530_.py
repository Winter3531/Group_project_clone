...
Revision ID: ac2f6fb6f4bc
Revises: 
Create Date: 2023-05-01 22:15:30.521226
...
def upgrade():
    ...
    sa.Column('likable_type', sa.Enum('user', 'album', 'playlist', 'song', name='likable_tpye'), nullable=False),
